    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white rounded-lg shadow-xl p-8">
        <div class="flex items-center justify-between mb-6">
          ...
          <span class="text-sm text-gray-500">December 8, 2025</span>
        </div>
        ...
        <div class="prose max-w-none">
          ...
          <p class="text-gray-600 mb-4">
            The Elves are setting up junction boxes in 3D space and want to connect them with strings of lights. To save on string lights, they connect pairs of junction boxes that are closest together based on straight-line distance.
          </p>
          <p class="text-gray-600 mb-4">
            When two junction boxes are connected, electricity can flow between them and they become part of the same circuit. The process continues by connecting the closest pairs that aren't already connected.
          </p>
          <p class="text-gray-600 mb-4">
            <strong>Part 1:</strong> After making 1000 connections, multiply together the sizes of the three largest circuits.
          </p>
          <p class="text-gray-600 mb-6">
            <strong>Part 2:</strong> Keep connecting junction boxes until they're all in one circuit. Multiply the X coordinates of the last two boxes you connected.
          </p>
          ...
          <div class="bg-gray-50 rounded-lg p-6 space-y-4">
            <div v-if="part1Answer !== null">
              ...
              <p class="text-sm text-gray-600">Product of three largest circuit sizes: {{ part1Answer }}</p>
            </div>
            <div v-if="part2Answer !== null" class="pt-4 border-t border-gray-300">
              ...
              <p class="text-sm text-gray-600">Product of X coordinates: {{ part2Answer }}</p>
            </div>
...
const { input } = useInputLoader('Day8Input.txt')
