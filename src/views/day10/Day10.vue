    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white rounded-lg shadow-xl p-8">
        <div class="flex items-center justify-between mb-6">
          ...
          <span class="text-sm text-gray-500">December 10, 2025</span>
        </div>
        ...
        <div class="prose max-w-none">
          ...
          <p class="text-gray-600 mb-4">
            The factory machines are offline and need initialization. Each machine has indicator lights that must match a specific pattern. The lights start in the off position and can be toggled by pushing buttons.
          </p>
          <p class="text-gray-600 mb-4">
            Each button toggles specific lights (turning on lights that are off and turning off lights that are on). You need to find the minimum number of button presses required to configure all indicator lights correctly.
          </p>
          <p class="text-gray-600 mb-4">
            <strong>Part 1:</strong> What is the fewest button presses required to correctly configure the indicator lights on all of the machines?
          </p>
          <p class="text-gray-600 mb-6">
            <strong>Part 2:</strong> Now configure the joltage counters instead. Each button press increments specific counters by 1. What is the fewest button presses required to reach the exact joltage requirements for all machines?
          </p>
          ...
          <div class="bg-gray-50 rounded-lg p-6 space-y-4">
            <div v-if="part1Answer !== null">
              ...
              <p class="text-sm text-gray-600">Total button presses required: {{ part1Answer }}</p>
            </div>
...
const { input } = useInputLoader('Day10Input.txt')
