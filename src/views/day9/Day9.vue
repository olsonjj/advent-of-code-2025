    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white rounded-lg shadow-xl p-8">
        <div class="flex items-center justify-between mb-6">
          ...
          <span class="text-sm text-gray-500">December 9, 2025</span>
        </div>
        ...
        <div class="prose max-w-none">
          ...
          <p class="text-gray-600 mb-4">
            The North Pole base movie theater has a tile floor with an interesting pattern. The Elves are redecorating by switching out square tiles. Some tiles are red, and they want to find the largest rectangle that uses red tiles for two of its opposite corners.
          </p>
          <p class="text-gray-600 mb-4">
            <strong>Part 1:</strong> Using two red tiles as opposite corners, what is the largest area of any rectangle you can make?
          </p>
          <p class="text-gray-600 mb-6">
            <strong>Part 2:</strong> The rectangle can only include red or green tiles. Green tiles form the border and interior of a closed loop connecting all red tiles. What is the largest area of any valid rectangle?
          </p>
          ...
          <div class="bg-gray-50 rounded-lg p-6 space-y-4">
            <div v-if="part1Answer !== null">
              ...
              <p class="text-sm text-gray-600">Largest rectangle area: {{ part1Answer }}</p>
            </div>
...
const { input } = useInputLoader('Day9Input.txt')
